      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_test_51JVdEbD1wTh6EU1DYdIrOEQtAlkJhvu7xzDfDai9AjJXWHSxbPAICLlhXH74n5v7BNpgCqlSMsKo5ef6Vk3JmQiv00hcoxbqZA");

            case 2:
              _this.stripe = _context.sent;
              elements = _this.stripe.elements(); //create our card element
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this2.paymentProcessing = true; //disables all form buttoms
              ...
              case 3:
                ...
                if (error) {
                  ...
                  }, 0); //calculate total using reduce
                  ...
                  axios.post('/api/purchase', _this2.customer).then(function (response) {
                    _this2.paymentProcessing = false; //form field no longer disabled
